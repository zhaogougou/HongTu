...
<%@ page import="com.Ht.Model.user_info" %><%--
...
<head>
  ...
  <link rel="stylesheet" href="//at.alicdn.com/t/font_1495642_k5qfl1w0ss.css">
...
<header id="header">
  ...
  <nav class="clear">
    ...
    <ul class="nav-list fl">
      ...
      <li class="nav-list-link fl">
        <a href="./html/model.html" class="nav-list-click">时代楷模</a>
      ...
      <li class="nav-list-link fl">
        <a href="./html/hotspot.html" class="nav-list-click">当今热点</a>
        <ol class="nav-list-con">
          <li class="nav-list-con-item">
      ...
      <li class="nav-list-link fl">
        <a href="./html/history.html" class="nav-list-click">铭记历史</a>
      </li>
      <li class="nav-list-link fl">
        <a href="./html/policy.html" class="nav-list-click">最新政策</a>
        <ol class="nav-list-con">
          <li class="nav-list-con-item">
      ...
      <li class="nav-list-link fl">
        <a href="./html/district.html" class="nav-list-click">红色老区</a>
      </li>
      <li class="nav-list-link fl">
        <a href="./html/hero.html" class="nav-list-click">平民英雄</a>
      </li>
      <li class="nav-list-link fl">
        <a href="./html/person.html" class="nav-list-click">个人中心</a>
      </li>
    </ul>
...
<article id="content">
    ...
    <div class="history-conts on">
      <ol class="history-lists">
        <li class="history-list">
          <a href="" class="history-list-link">
            <div class="his-con">
              ...
              <div class="his-con-item">
                ...
                <a href="">
                  <input type="submit" name="submit" id="sub" value="阅读详情">
                </a>
              </div>
            </div>
          </a>
  ...
  <div class="policy">
    ...
    <div class="policy-intro">
      <p>最新政策是用以指导具体政策的主导性政策。一般反映了占社会主导力量的社会群体的政治信仰和社会价值观，其中或多或少包括了政策决定者的政治信仰和社会价值观。主要特点是:(1)在层次上，基本政策一般由中央政府或其授权机关制定和发布，在层次上是比较高的；(2)在范围上，大多数情况下，基本政策在范围上要覆盖全国，适用于几乎所有的地域、行业、公民及公民团体；(3)在时间上，除非出现非常重大的变化，基本政策在相当长一段时期内是不会发生根本性变化的；(4)在权威上，只要是基本政策，都会被具体政策所援引，都会成为许多具体政策的政策依据，具有相当的权威性。</p>
    </div>
  ...
  <div class="hero">
    <div class="hero-title">
      <!-- <a href="">
        <h3>平民英雄</h3>
        <p class="hero-en">CIVILIAN HERO</p>
      </a> -->
    </div>
    <div class="hero-intro">
      <a href="">
        <!-- <p>默默无闻的普通人为大家或公众利益作出了异于常人、超越职责的无私牺牲。</p> -->
      </a>
    </div>
  </div>
  <!-- hero end -->
...
<footer>
  <div class="footer-content">
    ...
    <div class="copyright">
      ...
      <span>Copyright<i class="iconfont icon-copyright"></i>2019<strong>开发小组:Dockers</strong> All rights reserved 版权所有</span>
    </div>
  </div>
</footer>
<!-- fooer end -->
