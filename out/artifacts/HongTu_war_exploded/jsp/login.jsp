...
<head>
    ...
    <link rel="stylesheet" href="//at.alicdn.com/t/font_1495642_eieu8riw7zg.css">
...
<div id="login">
    <form action="LoginServlet" method="post" target="_blank" class="login-form">
        <h1 id="title">用户登录</h1>
        <div class="txtb">
            <input type="text" class="txt" id="user"  onblur="codeUser()"  name="user" required autocomplete="off">
            <p data-placeholder="用户名" class="tips"></p>
            <span id="userSpan" class="span"></span>
        </div>
        <div class="txtb">
            <input type="password" class="txt" onblur="codePwd()" id="password" name="password" required>
            <p data-placeholder="密码" class="tips"></p>
            <span id="passwordSpan" class="span"></span>
        </div>
        <input type="submit" class="but" value="登录" id="submit" />
        <div class="bottom-txt">
            没有账号？<a href="html/register.html" class="login-link ">注册</a>
        </div>
    </form>
</div>
<script>
