...
<div class="container">
    <form action="RegisterServlet" onsubmit="return Sub() " method="post">
        <h2>用户注册</h2>
        <div class="ipt">
            <label for="user" class="three">用户名:</label>
            <input type="text" name="user" id="user" alt="用户名" onblur="send('AjaxServlet')" class="box" placeholder="请输入1-9位数字" />
        </div>
        <p id="userpan"></p>

        <div class="ipt">
            <label for="password" class="two">密码:</label>
            <input type="password" name="password" id="password" alt="密码" onblur="codePassword()" class="box"
        ...
        <div class="ipt">
            ...
            <input type="tel" name="tel" id="tel" alt="手机号" onblur="codeTel()" class="box" placeholder="请输入您的手机号">
        </div>
        <p id="telpan"></p>
